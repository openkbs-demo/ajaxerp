...
async function runMigrations(db) {
  ...
  await db.query(`
    CREATE TABLE IF NOT EXISTS salary_templates (
      ...
      base_salary_bgn DECIMAL(10,2) NOT NULL,
      is_active BOOLEAN DEFAULT true,
      updated_at TIMESTAMP DEFAULT NOW()
    )
  `);
  ...
  await db.query(`
    CREATE TABLE IF NOT EXISTS medicine_catalog (
      ...
      price_per_unit_bgn DECIMAL(10,4) NOT NULL DEFAULT 0,
  ...
  await db.query(`
    CREATE TABLE IF NOT EXISTS monthly_pnl_snapshots (
      ...
      revenue_bgn DECIMAL(14,2) DEFAULT 0,
      feed_cost_bgn DECIMAL(14,2) DEFAULT 0,
      salary_cost_bgn DECIMAL(14,2) DEFAULT 0,
      vet_cost_bgn DECIMAL(14,2) DEFAULT 0,
      other_cost_bgn DECIMAL(14,2) DEFAULT 0,
      total_cost_bgn DECIMAL(14,2) DEFAULT 0,
      operating_profit_bgn DECIMAL(14,2) DEFAULT 0,
  ...
  await db.query(`
    CREATE TABLE IF NOT EXISTS bonus_calculations (
      ...
      base_salary_bgn DECIMAL(10,2),
      bonus_pct DECIMAL(5,2),
      bonus_amount_bgn DECIMAL(10,2),
      hall_id INTEGER REFERENCES halls(id),
